...
---@alias restore_opts {spawn_in_workspace: boolean?, relative: boolean?, absolute: boolean?, pane: Pane?, tab: MuxTab?, window: MuxWindow, on_pane_restore: fun(pane_tree: pane_tree)}
